...
alias rails-rebuild="echo 'bundle exec rake db:reset db:fixtures:load FIXTURES_PATH=spec/fixtures log:clear && rm -rf public/system/* && bundle exec rake db:test:prepare' | sh -x"
