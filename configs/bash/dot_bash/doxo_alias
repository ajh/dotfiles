...
# aspen
alias aspen-rebuild="rails-rebuild && echo 'bundle exec rake ts:rebuild bin:apply_sample_documents bin:apply_sample_logos_to_providers' | sh -x"
alias aspen-restart="rails-restart"
